...
from ragas import evaluate, EvaluationDataset, MultiTurnSample, RunConfig
...
class SkipArgsValueComparison(NonLLMStringSimilarity):
    """
    Skip tool call args string value similarity metric. Always returns 1.0.
    """
    ...
    async def _single_turn_ascore(
        ...
        """
        Skip tool call args string value similarity by return 1.0.
        """
        return 1.0
